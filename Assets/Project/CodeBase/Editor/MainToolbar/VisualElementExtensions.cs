...
namespace CodeBase.Editor.MainToolbar
{
    public static class VisualElementExtensions
    {
        ...
        /// </remarks>
        public static void RemoveFrom<T>(this T child, VisualElement parent) where T : VisualElement =>
            parent.Remove(child);
        ...
        public static VisualElement FindElementByName(this VisualElement element, string name) =>
            element.FindElement(e => e.name == name);
        ...
        public static VisualElement FindElementByTooltip(this VisualElement element, string tooltip) =>
            element.FindElement(e => e.tooltip == tooltip);
        ...
        /// <returns>The found VisualElement, or null if not found.</returns>
        public static VisualElement FindElementByClass(this VisualElement element, string className,
            System.Func<VisualElement, bool> filter = null) =>
            element.FindElement(e => e.ClassListContains(className) && (filter == null || filter(e)));
    }
}