...
{
    public class GameSceneStaticDataLoader : IGameSceneStaticDataLoader
    {
        ...
        public GameSceneStaticDataLoader(ICharacterStaticDataService characterStaticDataService,
